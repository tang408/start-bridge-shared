...
export const officialPartnerApi = {
     ...
     * 獲取 OfficialPartner 資料
     * @param {Object} params - 參數物件
     * @param {number} params.id - OfficialPartner 類型
     * @returns {Promise} API 響應
     */
    async getOfficialPartnerPreviewData(params = {}) {
        // 設定預設值和驗證
        const defaultParams = {
            id: 0 // 預設類型
        };
        ...
        return api.post('/f/public/official-partner/get-official-partner-preview-data', finalParams);
    }
};
